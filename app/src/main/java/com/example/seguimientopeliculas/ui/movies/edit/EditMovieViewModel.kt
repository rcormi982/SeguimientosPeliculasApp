        ...
        viewModelScope.launch {
            try {
                ...
                if (!isNetworkAvailable()) {
                    _uiState.value =
                        EditMovieUiState.Error("No hay conexión a Internet. No se pueden actualizar películas sin conexión.")
                    return@launch
                }
    ...
    fun deleteMovie(movieId: Int) {
        viewModelScope.launch {
            try {
                ...
                if (!isNetworkAvailable()) {
                    _uiState.value =
                        EditMovieUiState.Error("No hay conexión a Internet. No se pueden eliminar películas sin conexión.")
                    return@launch
                }
